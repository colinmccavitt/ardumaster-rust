...
pub use sitl::{
    apply_pitot_ratio, eas_from_tas, pitot_tas_from_body, tas_for_nav, use_airspeed_for_control,
    AirspeedHealthFlags, AirspeedSampleState, SitlAirspeedBackend, SitlAirspeedCluster,
    SitlAirspeedConfig, ARSPD_RATIO_DEFAULT, ARSPD_USE_DEFAULT, SITL_AIRSPEED_MAX_INSTANCES,
