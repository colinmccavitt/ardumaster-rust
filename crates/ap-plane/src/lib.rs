...
pub mod airspeed_analog_hookup;
...
pub mod airspeed_off_pcnt_hookup;
...
pub mod compass_use_for_yaw_hookup;
pub mod compass_primary_hookup;
pub mod compass_calibration_hookup;
...
pub mod q_options_failsafe_hookup;
