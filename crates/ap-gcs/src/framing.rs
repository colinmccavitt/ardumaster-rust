...
/// RC_CHANNELS (65), REQUEST_DATA_STREAM (66), MANUAL_CONTROL (69),
/// RC_CHANNELS_OVERRIDE (70), MISSION_ITEM_INT (73), VFR_HUD (74),
/// COMMAND_INT (75), COMMAND_LONG (76), BATTERY_STATUS (147), and
/// STATUSTEXT (253).
///
